...
get the app created:
    ...
    $ heroku apps:create avecaesar
    Creating avecaesar... done, stack is cedar
    http://avecaesar.herokuapp.com/ | git@heroku.com:avecaesar.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://avecaesar.herokuapp.com deployed to Heroku

    To git@heroku.com:avecaesar.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://avecaesar.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@avecaesar.herokuapp.com/repl
